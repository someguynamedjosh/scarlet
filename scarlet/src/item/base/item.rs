...
use super::{
    ...
    invariants::{InvariantCalculationContext, PredicateSet, PredicatesResult},
    util::Stack,
};
use crate::{
...
impl ItemPtr {
    ...
    pub fn get_invariants(&self) -> PredicatesResult {
        ...
        Ok(self.borrow().invariants.as_ref().unwrap().clone())
    }
}
...
pub struct Item {
    ...
    pub invariants: Option<PredicateSet>,
