...
impl DependencyCalculationContext {
    pub fn get_dependencies(&mut self, of_item: &ItemPtr, affects_return_value: bool) -> DepResult {
        ...
        RecursionPreventionStack::skip_recursion_or_execute_with_mutable_access(
            ...
            |this| {
                ...
                let mut deps = def.get_dependencies_using_context(
                    &of_item,
                    this,
        ...
        .unwrap_or_else(|| Dependencies::new_missing(of_item))
    }
