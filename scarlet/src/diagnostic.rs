...
impl Diagnostic {
    ...
    pub fn with_item<Definition: ItemDefinition<Definition, Analysis>, Analysis>(
        self,
        level: Level,
        item: &ItemRef<Definition, Analysis>,
    ) -> Self {
    ...
    pub fn with_item_info<Definition: ItemDefinition<Definition, Analysis>, Analysis>(
        self,
        item: &ItemRef<Definition, Analysis>,
    ) -> Self {
    ...
    pub fn with_item_warning<Definition: ItemDefinition<Definition, Analysis>, Analysis>(
        self,
        item: &ItemRef<Definition, Analysis>,
    ) -> Self {
    ...
    pub fn with_item_error<Definition: ItemDefinition<Definition, Analysis>, Analysis>(
        self,
        item: &ItemRef<Definition, Analysis>,
    ) -> Self {
